<!-- Typing SVG header -->
<p align="center">
  <img src="https://readme-typing-svg.demolab.com?font=Fira+Code&weight=600&size=28&duration=4000&pause=1000&color=00D4AA&center=true&vCenter=true&random=false&width=600&lines=Hey+%F0%9F%91%8B+I'm+Kazim;Open-Source+Contributor;Cybersecurity+Tool+Builder;Bug+Bounty+%7C+Web+Pentesting;Self-Taught+%7C+Building+in+Public" alt="Typing SVG" />
</p>

<!-- Badges -->
<p align="center">
  <img src="https://img.shields.io/badge/Focus-Bug_Bounty_%26_Pentesting-00D4AA?style=for-the-badge" />
  <img src="https://komarev.com/ghpvc/?username=kazim-45&style=for-the-badge&color=00d4aa" alt="Profile Views" />
  <img src="https://img.shields.io/badge/Based_in-Lahore,_Pakistan-green?style=for-the-badge" />
</p>
...
what_i_do:
  ...
  - Practicing on HackTheBox, TryHackMe & PicoCTF
  - Exploring offensive security through hands-on projects
...
building:
  - 🔑  PassAudit   — password strength & breach checker
  - 📋  LogWatch    — system log anomaly detector
  - 🌐  NetSpy      — live network packet sniffer & dashboard
  - 🔍  VaultScan   — git history secret scanner

open_to:
  - Bug bounty collaborations
  - Cybersecurity internships & junior roles
  - CTF teams
...
![Nmap](https://img.shields.io/badge/Nmap-00d4aa?style=for-the-badge&logo=nmap&logoColor=white)
...
![PicoCTF](https://img.shields.io/badge/PicoCTF-00D4AA?style=for-the-badge&logoColor=white)
...
|---|---|---|
| [**NetSpy**](https://github.com/kazim-45/netspy) | 🌐 Live network packet sniffer with browser dashboard — capture, filter & visualize traffic in real time | Python, Scapy, Flask |
| [**LogWatch**](https://github.com/kazim-45/logwatch) | 📋 System log anomaly detector — flags brute-force, root logins, after-hours access & port scans | Python, Rich |
| [**VaultScan**](https://github.com/kazim-45/vaultscan) | 🔍 Git history secret scanner — finds API keys & passwords buried in old commits | Python, Git |
...
- 🏴 **CTF Competitor** — HackTheBox, TryHackMe, PicoCTF
